...
#حقوق احمد @C_pIi - @C_pIi
# تطوير مودي الهيبه اذا ما ذكرت مصدر بنحكح امك @C_pIi - @SOURCE_ZE 
ownerID = int("6624744849") #ايدي الادمن 
...
async def start_msg(app, message):
      ...
      await message.reply('''
- مرحـبـًا عـزيـزي 🙋 {},
في بوت🖱 ¦ يـمكنك استـخـراج الـتـالـي 📥
...
async def generator_and_about(app,m):
    if m.text == "《مـعـلـومـات عـن الـبـوت》":
      ...
      text += f"\n🔥 اصـدار بايروجرام {v}"
      text += f"\n🌱 اصـدار تـيــلـيـثـون {v2}"
      text += f"\n\n👤 مـطـور الـبـوت: @C_pIi"
